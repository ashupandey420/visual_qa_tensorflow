...
def main():
    ...
    if args.split == 'train':
        ...
        coco_image_path =  open('data/preprocessed/images_train2014_path.txt', 'w')
        ...
        coco_image_path =  open('data/preprocessed/images_val2014_path.txt', 'w')
        ...
        coco_image_path =  open('data/preprocessed/images_test-dev2015_path.txt', 'w')
        ...
        coco_image_path =  open('data/preprocessed/images_test2015_path.txt', 'w')
    ...
    for i, q in pbar(zip(xrange(len(ques)),ques)):
        ...
        coco_image_path.write((image_path + '\n').encode('utf8'))
        if args.split == 'train' or args.split == 'val':
            if args.answers == 'modal':
